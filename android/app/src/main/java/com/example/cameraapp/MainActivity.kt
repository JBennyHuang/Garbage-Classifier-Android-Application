...
//                    Toast.makeText(baseContext, msg, Toast.LENGTH_SHORT).show()
                    ...
                    val bitmap = Bitmap.createScaledBitmap(BitmapFactory.decodeFile(photoFile.absolutePath), 224, 224, false)
                    ...
                    val _class = classes[max_index]
                    Toast.makeText(baseContext, "That is a $_class", Toast.LENGTH_LONG).show()
